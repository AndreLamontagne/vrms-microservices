...
public class AgentExceptionHandler {
    ...
    @ExceptionHandler(AgentDeletionBlockedException.class)
    public ResponseEntity<ApiErrorResponse> conflict(AgentDeletionBlockedException ex, HttpServletRequest req) {
        return build(HttpStatus.CONFLICT, ex, req);
    }
