...
public class OwnerExceptionHandler {
    ...
    @ExceptionHandler(OwnerDeletionBlockedException.class)
    public ResponseEntity<ApiErrorResponse> conflict(OwnerDeletionBlockedException ex, HttpServletRequest req) {
        return build(HttpStatus.CONFLICT, ex, req);
    }
