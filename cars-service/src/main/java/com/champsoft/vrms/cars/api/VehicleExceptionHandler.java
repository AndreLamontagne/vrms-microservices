...
public class VehicleExceptionHandler {
    ...
    @ExceptionHandler(VehicleDeletionBlockedException.class)
    public ResponseEntity<ApiErrorResponse> conflict(VehicleDeletionBlockedException ex, HttpServletRequest req) {
        return build(HttpStatus.CONFLICT, ex, req);
    }
    @ExceptionHandler({
