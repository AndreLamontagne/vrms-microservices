...
import com.champsoft.vrms.cars.application.exception.VehicleDeletionBlockedException;
...
public class VehicleCrudService {
    ...
    public VehicleCrudService(VehicleRepositoryPort repo, RegistrationUsagePort registrationUsagePort) {
        this.repo = repo;
    ...
    public void delete(String id) {
        ...
        if (registrationUsagePort.hasRegistrations(id)) {
            throw new VehicleDeletionBlockedException(
                    "Vehicle cannot be deleted because registrations already reference it: " + id
            );
        }
