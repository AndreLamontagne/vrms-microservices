...
public class RegistrationController {
    ...
    @GetMapping("/vehicles/{vehicleId}/exists")
    public ResponseEntity<Boolean> hasVehicleRegistrations(@PathVariable String vehicleId) {
        return ResponseEntity.ok(crud.hasVehicleRegistrations(vehicleId));
    }
    @GetMapping("/owners/{ownerId}/exists")
    public ResponseEntity<Boolean> hasOwnerRegistrations(@PathVariable String ownerId) {
        return ResponseEntity.ok(crud.hasOwnerRegistrations(ownerId));
    }
    @GetMapping("/agents/{agentId}/exists")
    public ResponseEntity<Boolean> hasAgentRegistrations(@PathVariable String agentId) {
        return ResponseEntity.ok(crud.hasAgentRegistrations(agentId));
    }
