...
public class RegistrationCrudService {
    ...
    @Transactional(readOnly = true)
    public boolean hasVehicleRegistrations(String vehicleId) {
        return repo.existsByVehicleId(vehicleId);
    }

    @Transactional(readOnly = true)
    public boolean hasOwnerRegistrations(String ownerId) {
        return repo.existsByOwnerId(ownerId);
    }

    @Transactional(readOnly = true)
    public boolean hasAgentRegistrations(String agentId) {
